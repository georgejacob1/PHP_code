                    ...
                    <select name="redirectURL1" class="banner-fild1">
                        ...
                        ?>
                            ...
                            <?php if (get_queried_object_id() == $term->term_id) {   ?>
                                ...
                                <option <?php if (get_queried_object_id() == $term->term_id || $link == $prev_url) {
                                            echo 'selected="selected"';
                                        } ?> value="<?php echo $link; ?>"><?php echo $term->name; ?></option>
                        ...
                        ?>
                            ...
                            <?php if (get_queried_object_id() == $term->term_id) {
                                ...
                                <option value="<?php echo $link; ?>"><?php echo $term->name; ?></option>
