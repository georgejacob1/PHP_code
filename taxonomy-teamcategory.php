...
<section class="conten-wrapp teamer-wrapp">
    <div class="margin">
        ...
        <div class="filter-col1">
            <div class="filter-row1 custom-select1">
                <select name="redirectURL1" class="banner-fild1">
                    ...
                    $terms = get_terms('teamcategory', array('hide_empty' => true,));  ?>
                    ...
                    ?>
                            ...
                            <option selected="selected" value="<?php echo get_term_link($tms->term_id); ?>"><?php echo $tms->name; ?></option>
                    ...
                    ?>
                            ...
                            <option value="<?php echo get_term_link($tms->term_id); ?>">
                                <?php echo $tms->name; ?>
                            </option>
        ...
        <div class="teamer-col1" style="display: none;">
                ...
                foreach ($terms as $tms) {
                    ...
                    if (!empty($posts_array)) {
                        ...
                        foreach ($posts_array as $item) {
                            ...
                            $team_list_image = aq_resize($img, 650, 757, true, true, true);

            ?>

                            <div class="teamer-col2 common-teams indiviual_<?php echo  $tms->term_id; ?>">
